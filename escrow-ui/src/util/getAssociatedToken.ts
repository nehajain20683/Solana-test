...
export const getAssociatedToken = async (
    ...
    //@ts-expect-error
    const XTokenMintAccountPubkey = new PublicKey((await connection.getParsedAccountInfo(contractId, 'singleGossip')).value!.data.parsed.info.mint);


    console.log("XTokenMintAccountPubkey ", XTokenMintAccountPubkey, XTokenMintAccountPubkey.toString())
